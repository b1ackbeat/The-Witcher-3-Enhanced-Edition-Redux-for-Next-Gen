...
class CModFriendlyHUDConfig
{
	...
	const var vitalityRiseThreshold: float; default vitalityRiseThreshold = 15;
	const var staminaRiseThreshold: float; default staminaRiseThreshold = 15;
	...
	const var oilsOrderStr : string; default
		oilsOrderStr = "Corrosive_Oil; Ethereal_Oil; Brown_Oil; Poisonous_Oil; Falka_Oil; Riming_Oil; Flammable_Oil; Paralysis_Oil; Silver_Oil";
	...
	public var enableWolfModuleOnStaminaChanged: bool;
	public var enableWolfModuleOnVigorChanged: bool;
	...
	public function UpdateUserSettings()
	{
		...
		enableWolfModuleOnStaminaChanged = theGame.GetInGameConfigWrapper().GetVarValue('fhudHUD', 'fhudEnableWolfModuleOnStaminaChanged');
		enableWolfModuleOnVigorChanged = theGame.GetInGameConfigWrapper().GetVarValue('fhudHUD', 'fhudEnableWolfModuleOnVigorChanged');

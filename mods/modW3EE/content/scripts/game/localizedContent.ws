...
function GetAttributeNameLocStr(attName : name, isMult : bool) : string
{
	...
	if(isMult)
	{
		locString = GetLocStringByKeyExt("attribute_name_"+StrLower(attName)+"_mult");
		if( locString == "" )
			locString = GetLocStringByKeyExt(StrLower(attName)+"_mult");
			
		if( locString == "" )
			locString = GetLocStringByKeyExt("attribute_name_"+StrLower(attName));
		if( locString == "" )
			locString = GetLocStringByKeyExt(StrLower(attName));
	}
	else
	{
		locString = GetLocStringByKeyExt("attribute_name_"+StrLower(attName));
...
function GetItemTooltipText(item : SItemUniqueId, inv : CInventoryComponent) : string
{
	...
	// W3EE - Begin
	return nam + "<br>" + category + "<br><br>" + strStats + "<br><br>" + GetLocStringByKeyExt(descript) + "<br><br>" + fluff + "<br><br>" + "fixme_Price: " + price;
	// W3EE - End
}

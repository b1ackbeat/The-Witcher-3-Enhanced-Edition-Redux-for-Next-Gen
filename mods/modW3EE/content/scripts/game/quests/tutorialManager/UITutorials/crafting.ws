...
exec function crafttut()
{
	theGame.GetTutorialSystem().uiHandler.GotoState('W3EECrafting');
}
exec function crafttut2()
{
	theGame.GetTutorialSystem().uiHandler.GotoState('CraftingSet');
}
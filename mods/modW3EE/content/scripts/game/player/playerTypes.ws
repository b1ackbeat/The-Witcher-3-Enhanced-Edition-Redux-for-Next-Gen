...
function SetItemNameToType( nam : name ) : EItemSetType
{
	switch( nam )
	{
		...
		case theGame.params.ITEM_SET_TAG_VAMPIRE_ALT :		return EIST_Vampire_Alt ;
		case theGame.params.ITEM_SET_TAG_TEMERIAN :			return EIST_Temerian ;
		case theGame.params.ITEM_SET_TAG_NILFGAARD :		return EIST_Nilfgaard ;
		case theGame.params.ITEM_SET_TAG_SKELLIGE :			return EIST_Skellige ;
		case theGame.params.ITEM_SET_TAG_OFIERI :			return EIST_Ofieri ;
		case theGame.params.ITEM_SET_TAG_NEW_MOON :			return EIST_New_Moon ;
		case theGame.params.ITEM_SET_TAG_VIPER : 			return EIST_Viper;
		case theGame.params.ITEM_SET_TAG_NETFLIX : 			return EIST_Netflix;
		case theGame.params.ITEM_SET_TAG_ELVEN : 			return EIST_Elven;
		case theGame.params.ITEM_SET_TAG_TIGER : 			return EIST_Tiger;
		case theGame.params.ITEM_SET_TAG_GOTHIC :			return EIST_Gothic;
		case theGame.params.ITEM_SET_TAG_DIMERITIUM :		return EIST_Dimeritium;
		case theGame.params.ITEM_SET_TAG_METEORITE : 		return EIST_Meteorite;

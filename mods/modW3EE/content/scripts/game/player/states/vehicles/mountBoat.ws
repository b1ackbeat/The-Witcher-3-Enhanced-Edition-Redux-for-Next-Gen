...
state MountBoat in CR4Player extends MountTheVehicle
{
	...
	event OnGameCameraTick( out moveData : SCameraMovementData, dt : float )
	{
		...
		{
			DampVectorSpring( moveData.cameraLocalSpaceOffset, moveData.cameraLocalSpaceOffsetVel, Vector( thePlayer.ic.sailOffset, thePlayer.ic.sailDepth, thePlayer.ic.sailHeight), 1.0f, dt );
			return false;
		}
	}

...
state Unconscious in CR4Player extends ExtendedMovable
{
	...
	entry function ProcessUncounscious()
	{
		...
		Sleep( 9.0 );
		// W3EE - Begin
		((W3PlayerWitcher)parent).AddTimer('RefreshVigor', 1.5f, false,,,,true);
		((W3PlayerWitcher)parent).AddTimer('CustomVigorTimerEnd', 1.f, false,,,,true);
		((W3PlayerWitcher)parent).AddTimer('ResumeVigorRegen', 1.5f, false,,,,true);
		// W3EE - End
		parent.GotoStateAuto();
	}

...
state CombatSword in W3PlayerWitcher extends Combat 
{
	...
	{	
		...
		if ( parent.GetBehaviorVariable( 'isPerformingSpecialAttack' ) == 0.f )
		{
			if ( enableAttack )
			{
				parent.AddCustomOrientationTarget( OT_CustomHeading, 'SpecialAttackHeavy' );
				parent.SetOrientationTargetCustomHeading( parent.GetCombatActionHeading(), 'SpecialAttackHeavy' );
				parent.SetBehaviorVariable( 'isPerformingSpecialAttack', 1.f );

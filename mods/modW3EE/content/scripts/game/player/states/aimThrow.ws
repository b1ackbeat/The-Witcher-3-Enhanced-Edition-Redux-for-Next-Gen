	...
	event OnGameCameraTick( out moveData : SCameraMovementData, dt : float )
	{
		...
		if ( parent.inv.IsItemCrossbow( parent.GetSelectedItemId() ) )
		{
			...
			if ( !parent.bLAxisReleased )
			{
				if ( rawToCamHeadingDiff > -45 && rawToCamHeadingDiff < 45 )
				{
					...
					{
						camOffsetVec.X = parent.ic.atOffset + 0.07;
						camOffsetVec.Y = parent.ic.atDepth  - 0.02;
						camOffsetVec.Z = parent.ic.atHeight - 0.04;
					}
				...
				else if ( rawToCamHeadingDiff >= 45 && rawToCamHeadingDiff < 135 )
				{
					...
					{
						camOffsetVec.X = parent.ic.atOffset + 0.12;
						camOffsetVec.Y = parent.ic.atDepth  + 0.03;
						camOffsetVec.Z = parent.ic.atHeight - 0.07;	
					}
				...
				else if ( rawToCamHeadingDiff <= -45 && rawToCamHeadingDiff > -135 )
				{
					...
					{
						camOffsetVec.X = parent.ic.atOffset + 0.07;
						camOffsetVec.Y = parent.ic.atDepth  - 0.07;
						camOffsetVec.Z = parent.ic.atHeight - 0.04;  
					}
				...
				else
				{
					...
					{
						camOffsetVec.X = parent.ic.atOffset + 0.12;
						camOffsetVec.Y = parent.ic.atDepth  + 0.08;
						camOffsetVec.Z = parent.ic.atHeight - 0.02;
					}
			...
			else
			{
				...
				{
					camOffsetVec.X = parent.ic.atOffset;
					camOffsetVec.Y = parent.ic.atDepth;
					camOffsetVec.Z = parent.ic.atHeight;
				}
			...
			if ( parent.ic.atRotate || !Options().EnableImmersiveCam())  //ImmersiveCam++
			{
		...
		else
		{
			...
			else
			{
				// ImmersiveCam++
				camOffsetVec.X = ( ( ( -20 - moveData.pivotRotationValue.Pitch )/100 ) - 0.85 ) * -1;
				camOffsetVec.X = ClampF( camOffsetVec.X, parent.ic.atOffset + 0.22, parent.ic.atOffset + 0.22f );
				camOffsetVec.Y = ( ( ( -20 - moveData.pivotRotationValue.Pitch )/-8 ) - 0.5 ) * -1;
				camOffsetVec.Y = ClampF( camOffsetVec.Y, parent.ic.atDepth + 0.02, parent.ic.atDepth + 0.28 );
				camOffsetVec.Z = ( ( ( -20 - moveData.pivotRotationValue.Pitch )/-74.07 ) ) * -1;
				camOffsetVec.Z = ClampF( camOffsetVec.Z, parent.ic.atHeight - 0.22, parent.ic.atHeight + 0.05 );

...
class W3MutagenDismantlingTable extends W3AlchemyTable
{
	event OnInteraction( actionName : string, activator : CEntity )
	{
		...
		if( actionName == "Use" )
		{
			...
			((CActor)activator).AddEffectDefault(EET_MutagenTable, (CActor)activator, "mutagentable");
			theGame.GetGuiManager().ShowNotification(GetLocStringByKeyExt("W3EE_MutagenTable"));

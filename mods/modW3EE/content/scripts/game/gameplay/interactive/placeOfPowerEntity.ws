...
state PlaceOfPower_Idle in CMajorPlaceOfPowerEntity
{
	...
	{	
		...
		// W3EE - Begin
		if(thePlayer && prevStateName == 'PlaceOfPower_Channeling')
		// W3EE - End
...
state PlaceOfPower_Channeling in CMajorPlaceOfPowerEntity
{
	...
	{	
		...
		// W3EE - Begin
		thePlayer.SetBehaviorVariable( 'MeditateWithIgnite', 0 );
		thePlayer.SetBehaviorVariable( 'HasCampfire', 0 );
		// W3EE - End
...
state PlaceOfPower_Activated in CMajorPlaceOfPowerEntity
{
	...
	{	
		...
		GrantBuff();
		if(prevStateName == 'PlaceOfPower_Channeling')
			thePlayer.PlayerStopAction( PEA_Meditation );
		// W3EE - End
	...
	// W3EE - Begin
	private function GrantSkillPointIfPossible( skillPath : ESkillSubPath )
	{	
		if( !parent.skillPointGranted )
		{
			Experience().ModTotalPathPoints(skillPath, 1);
			/*
	...
	private function GrantBuff()
	{
		...
		// W3EE - Begin
		Equipment().UpgradeMeteoriteArmor(parent.buffType);
		// W3EE - End
		...
		switch(parent.buffType)
		{
			case ESB_Aard:
				...
				// W3EE - Begin
				GrantSkillPointIfPossible(ESSP_Signs_Aard);
				// W3EE - End
				break;
			...
			case ESB_Axii:
				...
				// W3EE - Begin
				GrantSkillPointIfPossible(ESSP_Signs_Axi);
				// W3EE - End
				break;
			...
			case ESB_Igni:
				...
				// W3EE - Begin
				GrantSkillPointIfPossible(ESSP_Signs_Igni);
				// W3EE - End
				break;
			...
			case ESB_Quen:
				...
				// W3EE - Begin
				GrantSkillPointIfPossible(ESSP_Signs_Quen);
				// W3EE - End
				break;
			...
			case ESB_Yrden:
				...
				// W3EE - Begin
				GrantSkillPointIfPossible(ESSP_Signs_Yrden);
				// W3EE - End
				break;
		}
	}

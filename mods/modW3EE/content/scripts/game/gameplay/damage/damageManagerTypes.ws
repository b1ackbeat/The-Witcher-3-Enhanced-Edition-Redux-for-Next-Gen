...
struct SRawDamage
{
	...
	editable var dmgSplit : Float;
};

//W3EE Begin
struct SOilInfo
{
	var attributeNames : array<name>;
//	var appliedOilAttributeNames: array<name>;
	var attributeValues			: array<SAbilityAttributeValue>;
	var attributeValuesOriginal : array<SAbilityAttributeValue>;
	var activeIndex 			: array<bool>;
	var isActive 				: bool;
};
//W3EE End
...
function DamageHitsEssence(damageName : name) : bool
{
	switch(damageName)
	{
		...
		case theGame.params.DAMAGE_NAME_STAMINA: //W3EE
			return false;
		default :
			return true;
	}

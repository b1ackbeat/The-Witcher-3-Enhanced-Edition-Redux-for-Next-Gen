...
class W3Effect_Stagger extends W3CriticalEffect
{
	...
	event OnEffectAdded(optional customParams : W3BuffCustomParams)
	{
		...
		if(isOnPlayer)
		{
			...
			//Kolaris - Stagger Dodge Delay
			timeToEnableDodge = ((CBaseGameplayEffect)this).GetTimeLeft();
		}
	...
	event OnEffectRemoved()
	{
		...
		if( target.IsHuman() && (effectTime > 1.f || (CR4Player)target) )
		{
			target.NotifyStaggerEnd();
		}

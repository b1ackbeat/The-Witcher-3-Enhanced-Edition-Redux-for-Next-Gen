...
class W3LevelManager
{
	...
	// W3EE - Begin
	public function GetLevel() : int										{return Min(99, Experience().GetTotalSkillPoints());}
	// W3EE - End
	...
	public function GainLevel( show : bool ) : bool
	{
		...
		// W3EE - Begin
		if( CeilF(Options().SkillPointsGained()) != FloorF(Options().SkillPointsGained()) && level % 2 == 0)
			AddPoints(ESkillPoint, FloorF(Options().SkillPointsGained()) + 1, show);
		else
			AddPoints(ESkillPoint, FloorF(Options().SkillPointsGained()), show);
		/*

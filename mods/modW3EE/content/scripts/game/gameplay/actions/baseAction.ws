...
{
	// W3EE - Begin
	protected var appliedBleeding : bool;
	protected var wasPartiallyDodged : bool;
	public var originalDamage : SProcessedDamage;
	public var originalDamageArmor : SProcessedDamage;
	private var isCounterAttack : bool;
	// W3EE - End
	...
	// W3EE - Begin
	default appliedBleeding 				= false;
	default wasPartiallyDodged 				= false;
	// W3EE - End
	...
	public function SetIsCounterAttack( b : bool )
	{
		isCounterAttack = b;
	}
	
	public function IsCounterAttack() : bool
	{
	...
	// W3EE - Begin
	public function SetWasPartiallyDodged()						{wasPartiallyDodged = true;}
	public function GetWasPartiallyDoged() : bool				{return wasPartiallyDodged;}
	...
	// W3EE - Begin
	public function GetOriginalDamageDealt() : float
	{
		var actor : CActor;
		
		actor = (CActor)victim;
		if(actor && actor.UsesEssence())
			return originalDamage.essenceDamage;
		
		return originalDamage.vitalityDamage;
	}
	
	public function GetOriginalDamageDealtWithArmor() : float
	{
		var actor : CActor;
		
		actor = (CActor)victim;
		if(actor && actor.UsesEssence())
			return originalDamageArmor.essenceDamage;
		
		return originalDamageArmor.vitalityDamage;
	}
	// W3EE - End
	...
	public function GetPowerStatValue() : SAbilityAttributeValue
	{
		...
		else
		{
			...
			else result = SAbilityAttributeValue(0, 1, 0);
		}
		// W3EE - End

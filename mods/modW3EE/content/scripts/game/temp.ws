...
exec function dismember()
{
	...
	dismembermentComp.GetWoundsNames( wounds, WTF_All );
...
exec function dismembernum( a : name )
{
	var actor 				: CActor;	
	var dismembermentComp 	: CDismembermentComponent;
	var wounds				: array< name >;
...
exec function learnschem( n : name )
{
	GetWitcherPlayer().AddCraftingSchematic(n);
}
...
exec function addcraftedsteelrelic()
{
	...
	//W3EE - Begin
	thePlayer.inv.AddAnItem('Devine_crafted',1);
	thePlayer.inv.AddAnItem('Inis_crafted',1);
	thePlayer.inv.AddAnItem('Ardaenye_crafted',1);
	thePlayer.inv.AddAnItem('Barbersurgeon_crafted',1);
	thePlayer.inv.AddAnItem('Caerme_crafted',1);
	thePlayer.inv.AddAnItem('Deireadh_crafted',1);
	thePlayer.inv.AddAnItem('Gwyhyr_crafted',1);
	thePlayer.inv.AddAnItem('Princessxenthiasword_crafted',1);
	thePlayer.inv.AddAnItem('Robustswordofdolblathanna_crafted',1);
	thePlayer.inv.AddAnItem('Headtaker_crafted',1);
	thePlayer.inv.AddAnItem('Ultimatum_crafted',1);
	thePlayer.inv.AddAnItem('Lune_crafted',1);
	thePlayer.inv.AddAnItem('Gloryofthenorth_crafted',1);
	thePlayer.inv.AddAnItem('Torlara_crafted',1);
	thePlayer.inv.AddAnItem('Knights steel sword 3_crafted',1);
	//W3EE - End
...
exec function addcraftedsilverrelic()
{
	...
	//W3EE - Begin
	thePlayer.inv.AddAnItem('Azurewrath_crafted',1);
	thePlayer.inv.AddAnItem('Bloodsword_crafted',1);
	thePlayer.inv.AddAnItem('Naevdeseidhe_crafted',1);
	thePlayer.inv.AddAnItem('Zerrikanterment_crafted',1);
	thePlayer.inv.AddAnItem('Reachofthedamned_crafted',1);
	thePlayer.inv.AddAnItem('Havcaaren_crafted',1);
	thePlayer.inv.AddAnItem('Virgin_crafted',1);
	thePlayer.inv.AddAnItem('Tlareg_crafted',1);
	thePlayer.inv.AddAnItem('EP1 Crafted Witcher Silver Sword_crafted',1);
	//W3EE - End
	theGame.RequestMenuWithBackground( 'InventoryMenu', 'CommonMenu' );
}

//W3EE Begin
exec function addsteelrelicartifact()
{
	thePlayer.inv.AddAnItem('Arbitrator artifact',1);
	thePlayer.inv.AddAnItem('Beannshie artifact',1);
	thePlayer.inv.AddAnItem('Blackunicorn artifact',1);
	thePlayer.inv.AddAnItem('Longclaw artifact',1);
	thePlayer.inv.AddAnItem('Devine artifact',1);
	thePlayer.inv.AddAnItem('Inis artifact',1);
	thePlayer.inv.AddAnItem('Ardaenye artifact',1);
	thePlayer.inv.AddAnItem('Barbersurgeon artifact',1);
	thePlayer.inv.AddAnItem('Caerme artifact',1);
	thePlayer.inv.AddAnItem('Deireadh artifact',1);
	thePlayer.inv.AddAnItem('Gwyhyr artifact',1);
	thePlayer.inv.AddAnItem('Princessxenthiasword artifact',1);
	thePlayer.inv.AddAnItem('Robustswordofdolblathanna artifact',1);
	thePlayer.inv.AddAnItem('Headtaker artifact',1);
	thePlayer.inv.AddAnItem('Ultimatum artifact',1);
	thePlayer.inv.AddAnItem('Lune artifact',1);
	thePlayer.inv.AddAnItem('Gloryofthenorth artifact',1);
	thePlayer.inv.AddAnItem('Torlara artifact',1);
	thePlayer.inv.AddAnItem('Knights steel sword 3 artifact',1);

	theGame.RequestMenuWithBackground( 'InventoryMenu', 'CommonMenu' );
}

exec function addsilverrelicartifact()
{
	thePlayer.inv.AddAnItem('Harpy artifact',1);
	thePlayer.inv.AddAnItem('Negotiator artifact',1);
	thePlayer.inv.AddAnItem('Weeper artifact',1);
	thePlayer.inv.AddAnItem('Azurewrath artifact',1);
	thePlayer.inv.AddAnItem('Bloodsword artifact',1);
	thePlayer.inv.AddAnItem('Naevdeseidhe artifact',1);
	thePlayer.inv.AddAnItem('Zerrikanterment artifact',1);
	thePlayer.inv.AddAnItem('Reachofthedamned artifact',1);
	thePlayer.inv.AddAnItem('Havcaaren artifact',1);
	thePlayer.inv.AddAnItem('Virgin artifact',1);
	thePlayer.inv.AddAnItem('Tlareg artifact',1);
	thePlayer.inv.AddAnItem('EP1 Crafted Witcher Silver Sword artifact',1);
	theGame.RequestMenuWithBackground( 'InventoryMenu', 'CommonMenu' );
}
//W3EE - End
...
exec function gibvigor()
{
	thePlayer.ForceSetStat(BCS_Focus, thePlayer.GetStatMax(BCS_Focus));
}
...
exec function cleardevelop( optional keepInv : bool )
{
	var witcher : W3PlayerWitcher = GetWitcherPlayer();
	
	witcher.Debug_ClearCharacterDevelopment(keepInv);
	witcher.DrainFocus( witcher.GetStatMax(BCS_Focus) );
	witcher.GainStat( BCS_Focus, witcher.GetStatMax(BCS_Focus) );
}

exec function skillreset()
{
	var witcher : W3PlayerWitcher = GetWitcherPlayer();
...
exec function pottip(itemName : name)
{
	...
	thePlayer.inv.GetPotionAttributesForTooltip(itemName, null);
}
...
function rw_internal(typ : string, optional removeAllExisting : bool, optional onSilverSword : bool) : SItemUniqueId
{
	...
	if     (word == "Runeword 1"   || typ == "Napelnienie"   || typ == "Severance3")	  		{wordAsName = 'Runeword 1'; type = "Runeword";}
	else if(word == "Runeword 2"   || typ == "Przeciecie"    || typ == "Severance2") 		{wordAsName = 'Runeword 2'; type = "Runeword";}
	else if(word == "Runeword 4"   || typ == "Wigor"         || typ == "Obliteration3") 		{wordAsName = 'Runeword 4'; type = "Runeword";}
	else if(word == "Runeword 5"   || typ == "Utrwalenie"    || typ == "Severance1") 		{wordAsName = 'Runeword 5'; type = "Runeword";}
	else if(word == "Runeword 6"   || typ == "Pierogi"       || typ == "Obliteration1")			{wordAsName = 'Runeword 6'; type = "Runeword";}
	else if(word == "Runeword 8"   || typ == "Spokoj"        || typ == "Bereavement1") 		{wordAsName = 'Runeword 8'; type = "Runeword";}
	else if(word == "Runeword 10"  || typ == "Odnowienie"    || typ == "Obliteration2") 		{wordAsName = 'Runeword 10'; type = "Runeword";}
	else if(word == "Runeword 11"  || typ == "Przedluzenie"  || typ == "Bereavement3") 		{wordAsName = 'Runeword 11'; type = "Runeword";}
	else if(word == "Runeword 12"  || typ == "Triumf"        || typ == "Bereavement2") 			{wordAsName = 'Runeword 12'; type = "Runeword";}
	...
	else if(word == "Glyphword 8"  || typ == "Kolo"          || typ == "Rotation") 			{wordAsName = 'Glyphword 8'; type = "Glyphword";}
	else if(word == "Glyphword 9"  || typ == "Kolo"          || typ == "Rotation") 			{wordAsName = 'Glyphword 9'; type = "Glyphword";}
	else if(word == "Glyphword 10" || typ == "Zawaladniecie" || typ == "Usurpation") 		{wordAsName = 'Glyphword 10'; type = "Glyphword";}
	else if(word == "Glyphword 11" || typ == "Zawaladniecie" || typ == "Usurpation") 		{wordAsName = 'Glyphword 11'; type = "Glyphword";}
	else if(word == "Glyphword 12" || typ == "Ogien"         || typ == "Ignition") 			{wordAsName = 'Glyphword 12'; type = "Glyphword";}
	else if(word == "Glyphword 13" || typ == "Ogien"         || typ == "Ignition") 			{wordAsName = 'Glyphword 13'; type = "Glyphword";}
	...
	else if(word == "Glyphword 16" || typ == "Spetanie"      || typ == "Entanglement") 		{wordAsName = 'Glyphword 16'; type = "Glyphword";}
	...
	else if(word == "Glyphword 19" || typ == "Opetanie"      || typ == "Possession") 		{wordAsName = 'Glyphword 19'; type = "Glyphword";}
...
exec function ngp( set : string )
{
	...
	cnt = 35;
	set = StrLower(set);
	witcher.inv.AddAnItem( 'Greater mutagen blue', 100 );
	witcher.inv.AddAnItem( 'Greater mutagen red', 100 );
	witcher.inv.AddAnItem( 'Greater mutagen green', 100 );
	witcher.inv.AddAnItem('Allspice root',cnt);
	witcher.inv.AddAnItem('Arenaria',cnt);
	witcher.inv.AddAnItem('Balisse fruit',cnt);
	witcher.inv.AddAnItem('Beggartick blossoms',cnt);
	witcher.inv.AddAnItem('Berbercane fruit',cnt);
	witcher.inv.AddAnItem('Bison Grass',cnt);
	witcher.inv.AddAnItem('Bloodmoss',cnt);
	witcher.inv.AddAnItem('Blowbill',cnt);
	witcher.inv.AddAnItem('Bryonia',cnt);
	witcher.inv.AddAnItem('Buckthorn',cnt);
	witcher.inv.AddAnItem('Celandine',cnt);
	witcher.inv.AddAnItem('Cortinarius',cnt);
	witcher.inv.AddAnItem('Crows eye',cnt);
	witcher.inv.AddAnItem('Ergot seeds',cnt);
	witcher.inv.AddAnItem('Fools parsley leaves',cnt);
	witcher.inv.AddAnItem('Ginatia petals',cnt);
	witcher.inv.AddAnItem('Green mold',cnt);
	witcher.inv.AddAnItem('Han',cnt);
	witcher.inv.AddAnItem('Hellebore petals',cnt);
	witcher.inv.AddAnItem('Honeysuckle',cnt);
	witcher.inv.AddAnItem('Hop umbels',cnt);
	witcher.inv.AddAnItem('Hornwort',cnt);
	witcher.inv.AddAnItem('Longrube',cnt);
	witcher.inv.AddAnItem('Mandrake root',cnt);
	witcher.inv.AddAnItem('Mistletoe',cnt);
	witcher.inv.AddAnItem('Moleyarrow',cnt);
	witcher.inv.AddAnItem('Nostrix',cnt);
	witcher.inv.AddAnItem('Pigskin puffball',cnt);
	witcher.inv.AddAnItem('Pringrape',cnt);
	witcher.inv.AddAnItem('Ranogrin',cnt);
	witcher.inv.AddAnItem('Ribleaf',cnt);
	witcher.inv.AddAnItem('Sewant mushrooms',cnt);
	witcher.inv.AddAnItem('Verbena',cnt);
	witcher.inv.AddAnItem('White myrtle',cnt);
	witcher.inv.AddAnItem('Wolfsbane',cnt);
	witcher.inv.AddAnItem('Bottle', 1);
	witcher.inv.AddAnItem('Alcohest', 15);
	switch( set )
	{
		case 'cat':
			witcher.AddAndEquipItem( 'Lynx Armor 4' );
	...
	for(i=1; i<EnumGetMax('ESkillSubPath') - 5; i+=1)
		Experience().ModTotalPathPoints((ESkillSubPath)i, 50, true);
}
...
exec function addW3EEOils()
{
	thePlayer.inv.AddAnItem('Corrosive Oil 1',6);
	thePlayer.inv.AddAnItem('Corrosive Oil 2',6);
	thePlayer.inv.AddAnItem('Corrosive Oil 3',6);
	thePlayer.inv.AddAnItem('Ethereal Oil 1',6);
	thePlayer.inv.AddAnItem('Ethereal Oil 2',6);
	thePlayer.inv.AddAnItem('Ethereal Oil 3',6);
	thePlayer.inv.AddAnItem('Brown Oil 1',6);
	thePlayer.inv.AddAnItem('Brown Oil 2',6);
	thePlayer.inv.AddAnItem('Brown Oil 3',6);
	thePlayer.inv.AddAnItem('Poisonous Oil 1',6);
	thePlayer.inv.AddAnItem('Poisonous Oil 2',6);
	thePlayer.inv.AddAnItem('Poisonous Oil 3',6);
	thePlayer.inv.AddAnItem('Falka Oil 1',6);
	thePlayer.inv.AddAnItem('Falka Oil 2',6);
	thePlayer.inv.AddAnItem('Falka Oil 3',6);
	thePlayer.inv.AddAnItem('Riming Oil 1',6);
	thePlayer.inv.AddAnItem('Riming Oil 2',6);
	thePlayer.inv.AddAnItem('Riming Oil 3',6);
	thePlayer.inv.AddAnItem('Flammable Oil 1',6);
	thePlayer.inv.AddAnItem('Flammable Oil 2',6);
	thePlayer.inv.AddAnItem('Flammable Oil 3',6);
	thePlayer.inv.AddAnItem('Paralysis Oil 1',6);
	thePlayer.inv.AddAnItem('Paralysis Oil 2',6);
	thePlayer.inv.AddAnItem('Paralysis Oil 3',6);
	thePlayer.inv.AddAnItem('Silver Oil 1',6);
}

exec function addW3EEOilRecipes()
{
	thePlayer.inv.AddAnItem('Recipe for Corrosive Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Corrosive Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Corrosive Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Ethereal Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Ethereal Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Ethereal Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Brown Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Brown Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Brown Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Poisonous Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Poisonous Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Poisonous Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Falka Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Falka Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Falka Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Riming Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Riming Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Riming Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Flammable Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Flammable Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Flammable Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Paralysis Oil 1',1);
	thePlayer.inv.AddAnItem('Recipe for Paralysis Oil 2',1);
	thePlayer.inv.AddAnItem('Recipe for Paralysis Oil 3',1);
	thePlayer.inv.AddAnItem('Recipe for Silver Oil 1',1);
}

exec function showWeatherCondition()
{
	var weatherCondition : name; //W3EE
	
	weatherCondition = GetWeatherConditionName();
	
	GetWitcherPlayer().DisplayHudMessage(weatherCondition);
}

exec function healeffects()
{
	thePlayer.RemoveBuff(EET_Bleeding);
	thePlayer.RemoveBuff(EET_Poison);
}

exec function displaytoxicity()
{
	((W3Effect_Toxicity)GetWitcherPlayer().GetBuff(EET_Toxicity)).DisplayToxicity();
}
...
class CBTTaskHitReactionDecorator extends CBTTaskPlayAnimationEventDecorator
{
	...
	function CheckGuardOrCounter() : bool
	{
		...
		// W3EE - Begin
		if( ((W3DamageAction)damageData).IsCounterAttack() || (((W3DamageAction)damageData).GetHitAnimationPlayType() == EAHA_ForceYes && ((W3DamageAction)damageData).CanPlayHitParticle() == false) )
			return false;

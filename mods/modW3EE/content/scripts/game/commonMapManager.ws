...
import struct SCommonMapPinInstance
{
	...
	import var entities : array<CEntity>; // -= WMK:modAQOOM =-
	import var isDynamic : bool; // -= WMK:modAQOOM =-
	...
	import var canBeAddedToMinimap : bool; // -= WMK:modAQOOM =-
	import var isAddedToMinimap : bool; // -= WMK:modAQOOM =-
	import var invalidated : bool; // -= WMK:modAQOOM =-
}
...
import abstract class CCommonMapManager extends IGameSystem
{
	...
	public function SetEntityMapPinDiscoveredScript(isFastTravelPoint : bool, tag : name, optional set : bool )
	{
		...
		if( !previouslyDiscovered && isFastTravelPoint && set)
		{
			...
			// W3EE - Begin
			Experience().AwardGeneralXP(false);
			// W3EE - End
		}
